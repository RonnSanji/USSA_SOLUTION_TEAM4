...
private static final long serialVersionUID = 1L;
	...
	public TransactionReport() throws FileNotFoundException, FieldMismatchExcepion{
		...
		List<Product>proList=new ArrayList<Product>((Collection<? extends Product>) FileDataWrapper.productMap.values());
		for (Product prod : proList) {
			productMap.put(prod.getProductId(), prod);
		}
		//transaction
		List<Transaction>txList=new ArrayList<Transaction>(FileDataWrapper.transactionList);
